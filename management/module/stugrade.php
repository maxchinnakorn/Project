...
$sqlyear="SELECT MAX(`year`) FROM `stu_score`;";
$objyear=mysql_query($sqlyear);
$showyear=mysql_fetch_row($objyear);
$cr=0;
$GPA=0;
...
if(empty($numlist))
{
	echo "ยังไม่มีผลการเรียนภาคเรียน ที่ 1 ปีการศึกษา ".$showyear[0];
}
else
{
	?>
  ...
  <tbody>
    <tr bgcolor='#CCCCFF'>
      <td colspan="5" align="center">ภาคเรียนที่ 1 ปีการศึกษา <?=$showyear[0]?></td>
    </tr>
    <tr bgcolor='#9FFFFF'>
...
<p>
<?
//echo "กำลังดำเนินการแจ้งผลการเรียนภาคเรียนที่ 2 จะแสดงผลในเร็วๆ นี้";
include "stugrade2.php";
?>
</p>
