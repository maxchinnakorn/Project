...
$sqlupdatedata = "UPDATE `data_personal` SET 
...
WHERE (`personal_id`='".$_POST['id']."')";
$queryupdatedata = mysql_query($sqlupdatedata);
//echo $sqlinsertdata;
echo "<center><font size='8' color='green'>แก้ไขทะเบียนเรียบร้อย</font></center>";
echo "<meta http-equiv='Refresh' content='3;URL=../../home.php?page=vichakarn&work=register_personal_edit'>";
?>